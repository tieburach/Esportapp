...
public class ResultWindow extends Application {
    ...
    public void start(Stage stage) throws FileNotFoundException {
        ...
        opis1.setPrefSize(360, 130);
        opis1.setStyle("-fx-font-size: 12px");

        Label opis2 = new Label();
        opis2.setPadding(new Insets(10));
        opis2.setWrapText(true);
        opis2.setPrefSize(320, 130);
        opis2.setStyle("-fx-font-size: 12px");

        Label opis3 = new Label();
        opis3.setPadding(new Insets(10));
        opis3.setPrefSize(360, 130);
        opis3.setWrapText(true);
        opis3.setStyle("-fx-font-size: 12px");

        Label opis4 = new Label();
        opis4.setPadding(new Insets(10));
        opis4.setWrapText(true);
        opis4.setPrefSize(320, 130);
        opis4.setStyle("-fx-font-size: 12px");

        SplitPane gora = new SplitPane();
        gora.setMaxSize(740, 130);
        ...
        if (wynikodpornosc < 5) {
            ...
            opis1.setText("Wynik koherencji (odpornosci na stres):\n" + "To oznacza niską odporność psychiczną. Zapewne bez przerwy jesteś spięty i aby osiągnąć cel (nawet niezbyt ambitny), musisz mobilizować wszystkie siły. Głęboko przemyśl, co powinieneś zmienić w sobie i swoim zachowaniu.");
        }
        ...
        if (wynikniezdecydowany < 5) {
            ...
            opis3.setText("Wynik ambiwalentności (niezdecydowania):\n" + "Często zmieniasz swoje zdanie. Masz ambitne plany, ale ich nie realizujesz. Wpadasz w panikę, gdy czeka Cię nowe zadanie. W opinii kolegów nie można na Tobie polegać. Nie cieszy Cię to, co robisz, wykonujesz to mechanicznie.");
        }
        ...
        if (wynikdobrzedzialac > 8) {
            ...
            ModelWyniki.incrementpodejmowanie();
            opis4.setText("Wynik czy potrafisz dzialać: \n" + "Masz bardzo wysoką odporność psychiczną, a swoim zdecydowaniem dajesz innym poczucie bezpieczeństwa. Odwagi do działania dodaje Ci ciekawość świata. Podejmowanie decyzji sprawia Ci satysfakcję. Potrafisz zaplanować pracę, własne wydatki i życie.");
        }
        ...
        Image image1 = new Image(new FileInputStream("C:\\Users\\Tieburach\\Desktop\\Esportapp\\src\\kinaszw\\sources\\wyniki.png"));
